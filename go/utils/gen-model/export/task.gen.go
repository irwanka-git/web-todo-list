...
import (
	...
	"irwanka/webtodolist/utils/gen-model/entity"
)
...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.IDTask = field.NewInt32(tableName, "id_task")
	...
	_task.CreateBy = field.NewInt32(tableName, "create_by")
...
func (t *task) updateTableName(table string) *task {
	...
	t.IDTask = field.NewInt32(table, "id_task")
